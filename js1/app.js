(function () {
  ...
  var SVG_CLASSIC = {
    ...
    imagegen: '<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="16" rx="2.5" stroke="rgba(70,74,80,0.82)" stroke-width="1.2"/><circle cx="8.6" cy="9.4" r="1.6" stroke="rgba(130,136,145,0.65)" stroke-width="1.1"/><path d="M3.6 17.4l4.6-4 3.2 2.6 4.1-3.6 5 4.6" stroke="rgba(130,136,145,0.65)" stroke-width="1.1" stroke-linejoin="round"/><path d="M18.4 2.2l.62 1.48 1.48.62-1.48.62-.62 1.48-.62-1.48L16.3 4.3l1.48-.62z" fill="rgba(70,74,80,0.82)" opacity="0.72"/></svg>',
  ...
  var SVG_ALT = {
    ...
    fun: SVG_ENT,
    imagegen: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2M8.5 7.4c1.05 0 1.9.85 1.9 1.9s-.85 1.9-1.9 1.9-1.9-.85-1.9-1.9.85-1.9 1.9-1.9m11.3 11.4H4.2l3.9-4.7c.2-.24.55-.27.79-.06l3.11 2.53 4.21-3.7a.55.55 0 0 1 .74.04l4.2 4.1c.19.19.28.44.28.7 0 .58-.47 1.09-1.03 1.09"></path></svg>',
  ...
  if ('serviceWorker' in navigator && (location.protocol === 'https:' || location.hostname === 'localhost')) {
    window.addEventListener('load', function () {
      navigator.serviceWorker.register('./sw.js?v=69').then(function (reg) {
