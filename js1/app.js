(function () {
  ...
  var SVG_CLASSIC = {
    ...
    imagegen: '<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="5.5" width="18" height="14.5" rx="2.4" stroke="rgba(70,74,80,0.82)" stroke-width="1.25"/><circle cx="8.4" cy="10.4" r="1.5" stroke="rgba(130,136,145,0.7)" stroke-width="1.1"/><path d="M3.9 17.6l4.3-3.9 3 2.5 4-3.6 4.9 4.4" stroke="rgba(130,136,145,0.7)" stroke-width="1.1" stroke-linejoin="round"/><path d="M18.9 2.1l.68 1.62 1.62.68-1.62.68-.68 1.62-.68-1.62-1.62-.68 1.62-.68z" fill="rgba(70,74,80,0.8)"/></svg>',
