...
| 文档 | 内容 |
|---|---|
| [`docs/卡片输出规则-可直接粘贴.md`](./docs/卡片输出规则-可直接粘贴.md) | 状态卡片的**世界书输出规则**（整段可复制）+ **格式速查表**。想让别的角色卡也用上卡片，照这份改卡即可，无需改代码 |
| [`docs/冒险者手札-使用说明.md`](./docs/冒险者手札-使用说明.md) | 卡片渲染器的说明：显示在哪、自适应原理、涉及文件与验证结果 |
